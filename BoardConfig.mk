...
BOARD_AVB_MAKE_VBMETA_IMAGE_ARGS += --flags 0  # Disable verification
...
BOARD_RECOVERY_IGNORE_SEPOLICY := true
BOARD_RECOVERY_DISABLE_SEPOLICY := true

# Super Partition Devices
BOARD_SUPER_PARTITION_BLOCK_DEVICES := system vendor
BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE := 7516192768
BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE := 1610612736BOARD_RECOVERY_DISABLE_SEPOLICY := true
